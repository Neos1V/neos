...
import {
  footerQuery,
  navQuery,
  termesConditionsVentesQuery,
} from "@/sanity/lib/query";
import type {
  Footer,
  NavType,
  TermesConditionsVentesDoc,
...
export default async function Page() {
  ...
  const data = await sanityFetch<TermesConditionsVentesDoc>({
    query: termesConditionsVentesQuery,
    tags: ["termesConditionsVentes"],
  });
