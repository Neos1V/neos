...
import {
  footerQuery,
  mentionsLegalesQuery,
  navQuery,
} from "@/sanity/lib/query";
import type { Footer, MentionsLegalesDoc, NavType } from "@/sanity/lib/type";
...
export default async function Page() {
  ...
  const data = await sanityFetch<MentionsLegalesDoc>({
    query: mentionsLegalesQuery,
    tags: ["mentionsLegales"],
  });
