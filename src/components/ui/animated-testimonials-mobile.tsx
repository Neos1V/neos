  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-10 md:grid-cols-2 lg:flex lg:gap-[60px] lg:items-end lg:justify-between lg:max-w-[1200px] lg:mx-auto">
          ...
          <div className="relative h-80 w-full">
            <AnimatePresence>
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="relative w-full h-full md:w-full md:h-full lg:w-[370px] lg:h-[463px] border-4 border-white rounded-2xl lg:rounded-2xl overflow-hidden">
                    <img
                      ...
                      height={463}
                      draggable={false}
                      className="h-full w-full object-cover object-center rounded-3xl lg:rounded-none"
                    />
        ...
        {/* Section Texte */}
        <div className="flex flex-col justify-between px-6 lg:px-0 py-4 lg:pt-[50px] lg:pl-8 lg:pb-8 rounded-2xl lg:w-[750px] bg-white shadow-xl lg:relative">
          <img
            src="star.svg"
            alt="star"
            className="absolute top-0 right-0 hidden lg:block"
          />
          <p className="rounded-full bg-white border border-[#F7F8F9] py-1 px-2 shadow font-bold text-sm w-fit absolute -top-4 -left-8 -rotate-[30deg] hidden lg:block">
            Avis client
          </p>
          <motion.div
            key={active}
          ...
          >
            <h3 className="text-base lg:text-2xl font-bold text-black dark:text-white">
              {testimonials[active].titre}
            </h3>

            <motion.p className="mt-4 lg:mt-8 text-sm lg:text-lg text-gray-500 dark:text-neutral-300">
          ...
          <div className="flex gap-4 md:pt-0 justify-between items-center pr-8 mt-7">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                >
                  <path
                    d="M1.2842 1.18203C1.37716 1.0883 1.48777 1.01391 1.60962 0.963138C1.73148 0.912369 1.86219 0.88623 1.9942 0.88623C2.12621 0.88623 2.25692 0.912369 2.37878 0.963138C2.50064 1.01391 2.61124 1.0883 2.7042 1.18203L7.7042 6.18203C7.79793 6.27499 7.87232 6.38559 7.92309 6.50745C7.97386 6.62931 8 6.76002 8 6.89203C8 7.02404 7.97386 7.15475 7.92309 7.27661C7.87232 7.39846 7.79793 7.50907 7.7042 7.60203L2.7042 12.602C2.61124 12.6958 2.50064 12.7702 2.37878 12.8209C2.25692 12.8717 2.12621 12.8978 1.9942 12.8978C1.86219 12.8978 1.73148 12.8717 1.60962 12.8209C1.48777 12.7702 1.37716 12.6958 1.2842 12.602C1.19047 12.5091 1.11608 12.3985 1.06531 12.2766C1.01454 12.1547 0.9884 12.024 0.9884 11.892C0.9884 11.76 1.01454 11.6293 1.06531 11.5075C1.11608 11.3856 1.19047 11.275 1.2842 11.182L5.5842 6.89203L1.2842 2.60203C1.19047 2.50907 1.11608 2.39846 1.06531 2.27661C1.01454 2.15475 0.9884 2.02404 0.9884 1.89203C0.9884 1.76002 1.01454 1.62931 1.06531 1.50745C1.11608 1.38559 1.19047 1.27499 1.2842 1.18203Z"
                    fill="#0551D2"
                  />
                </svg>
              </button>
